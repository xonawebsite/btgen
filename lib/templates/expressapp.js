...
const expressBin = require('../files/expressbin.js.js');
...
const expressIndexRoute = require('../files/expressindexroute.js.js');
const expressUserRoute = require('../files/expressuserroute.js.js');
const expressIndexView = require('../files/expressindexview.js.js');
const expressErrorView = require('../files/expresserrorview.js.js');
const expressAppJS = require('../files/expressappjs.js.js');
const expressPackageJson = require('../files/json.js.js');
